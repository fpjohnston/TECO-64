...
| ATS        | Illegal at-sign, or too many at-signs | TBD |
...
| BOA        | O argument is out of range | TBD |
| CHR        | Invalid character for command | TBD |
| COL        | Illegal colon, or too many colons | TBD |
| DIV        | Division by zero | TBD |
| DPY        | Display mode initialization error | TBD |
| DTB        | Delete too big | An nD command has been attempted which is not contained within the current page. |
| DUP        | Duplicate tag "!x!" | TBD |
| EGC        | EG command is too long | TBD |
| FIL        | Illegal file "x" | TBD |
...
| IFE        | Ill-formed numeric expression | TBD |
...
| IMA        | Illegal m argument | TBD |
| INA        | Illegal n argument | TBD |
| INI        | Initialization error | TBD |
| IOA        | Illegal O argument | TBD |
...
| NAT        | Cannot have n argument and text string | TBD |
...
| NOD        | Display mode support not enabled | TBD |
| NON        | No n argument after m argument | TBD |
| NOT        | O command has no tag | TBD |
...
| YCA        | Y command aborted | An attempt has been made to execute an Y or _ search command with an output file open, that would cause text in the text buffer to be erased without outputting it to the output file. The ED command controls this check. |
