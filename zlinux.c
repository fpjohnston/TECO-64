...
*****************************************************************************/
int ZChIn(NoWait)           /* input a character from terminal */
...
LONG ZClnEG(                    /* execute special :EG command */
    int EGWhat,         /* what to get/set/clear: MEM, LIB, etc. */
    int EGOper,         /* operation: get, set or clear */
...
*****************************************************************************/
int ZExCtB()            /* return current date */
{
    time_t clockt;
...
*****************************************************************************/
int ZExCtH()            /* return current time */
{
    time_t clockt;
    struct tm *time_of_day;
    int tecotime;
...
*****************************************************************************/
int ZExeEJ()            /* execute an EJ command */
{
...
int IfIndx;             /* index into IFiles array */
{
...
int OfIndx;             /* index into OFiles array */
{
...
*****************************************************************************/
int ZOpInp(IfIndx, EIFile, RepFNF)
int IfIndx;         /* index into file data block array IFiles */
 ...
 * by this routine.
 */
int ZOpOut(OfIndx, RepErr, Backup)      /* open output file */
int OfIndx;             /* output file indicator */
...
int ZPWild()        /* preset the wildcard lookup filename */
{
    int result, i;
    /*
...
*****************************************************************************/
int ZSetTT(TTWhat, TTVal)   /* tell operating system we set the term. */
int TTWhat;     /* what terminal parameter to set */
int TTVal;      /* what to set it to */
{
    return ExeNYI();
}
/*****************************************************************************
...
*****************************************************************************/
/* Rewritten 05/04 by TAA */
int ZSWild()        /* search for next wildcard filename */
{
    int filename_length;
...
buffer to be output.
*****************************************************************************/
int ZWrBfr(OfIndx, BfrBeg, BfrEnd)
int OfIndx;         /* index into OFiles array */
